    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 bg-secondary/10">
        <header className="bg-white shadow-sm py-4 px-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Welcome Property Owner</p>
            </div>
                    ...
                    <div className="bg-secondary/20 p-3 rounded-lg">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">John Doe has paid KES 35,000 for April rent</p>
                        </div>
                      </div>
                    </div>
                    <div className="bg-secondary/20 p-3 rounded-lg">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">New maintenance request for Apartment 2B</p>
                        </div>
                      </div>
                    </div>
                    <div className="bg-secondary/20 p-3 rounded-lg">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Sarah's lease expires in 30 days</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="p-4 sm:p-6">
          ...
          {/* Add other tabs as needed, similar to the tenant dashboard */}
        </div>
      </div>
    </div>
  );
