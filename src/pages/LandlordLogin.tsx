...
const LandlordLogin = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For landlords, specifically navigate to landlord dashboard
          ...
          <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden">
            <div className="p-8">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold mb-2">Landlord Portal Login</h2>
                <p className="text-muted-foreground">
                  Access your properties, manage tenants, and collect rent
                </p>
              </div>
