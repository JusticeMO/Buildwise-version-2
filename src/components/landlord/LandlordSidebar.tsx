...
import { LogOut, Home, CreditCard, MessageSquare, Users, ClipboardList, Settings, PieChart, Building2 } from 'lucide-react';
...
const LandlordSidebar = ({ onLogout, onNavChange, activeTab }: LandlordSidebarProps) => {
  const navItems = [
    ...
    { id: 'payments', label: 'Rent Collection', icon: <CreditCard size={18} /> },
    { id: 'messages', label: 'Messages', icon: <MessageSquare size={18} /> },
    { id: 'reports', label: 'Reports', icon: <PieChart size={18} /> },
    { id: 'documents', label: 'Documents', icon: <ClipboardList size={18} /> },
